...
public class AnagramsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            dictionary = new AnagramDictionary(new InputStreamReader(inputStream), 3);
        } catch (IOException e) {
    ...
    private void processWord(EditText editText) {
        ...
        String color = "#cc0029";
        Log.d("isGoodWord", Boolean.toString(dictionary.isGoodWord(word, currentWord)));
        Log.d("anagramsContains", Boolean.toString(anagrams.contains(word)));
